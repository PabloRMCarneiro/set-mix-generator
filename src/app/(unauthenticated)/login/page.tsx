...
export default function Home() {
 ...
 /*  if (session.status === "authenticated") {
  ...
  return (
    <div className="relative isolate overflow-hidden  sm:py-80 " >
      <div
        className="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl"
        aria-hidden="true"
      >
        <div
          className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#ffffff] to-[#636368] opacity-20"
          style={{
            clipPath:
      ...
      >
        <div
          className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#ffffff] to-[#75757a] opacity-20"
          style={{
            clipPath:
              "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
          }}
      ...
      <div className=" mx-auto max-w-7xl px-6 lg:px-8 mt-[-120px]">
        <div className="mx-auto max-w-2xl lg:mx-0 ">
          <h2 className="text-4xl tracking-wider font-bold tracking-tight text-white sm:text-6xl">
            Mixingfy
          </h2>
        ...
        <div className="m x-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl className="mt-42 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
